    ...
    <div style={{ position: 'fixed', inset: 0, background: '#000', zIndex: 300, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', flexShrink: 0 }}>
        <button onClick={() => { setIsPaused(!isPaused); if (!isPaused) setShowQuit(false); }} style={{
          width: 40, height: 40, borderRadius: '50%', background: 'var(--accent-mint)',
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button onClick={() => setShowSettings(true)} style={{ background: 'none', border: 'none', color: 'var(--accent-mint)', padding: 4 }}>
      ...
      <div style={{
        ...
        <button onClick={handleNext} style={{
          width: 48, height: 48, borderRadius: '50%', background: 'var(--accent-mint)',
          display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none',
        }}>
    ...
    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.6)', zIndex: 30, display: 'flex', alignItems: 'flex-end' }} onClick={onClose}>
      <div style={{
        ...
        <button onClick={addSet} style={{
          ...
          color: 'var(--accent-mint)', fontSize: 14, fontWeight: 600, marginBottom: 16,
        }}>
          + Add More
        </button>
